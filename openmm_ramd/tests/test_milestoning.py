...
def test_make_milestoning_model():
    milestones = [2.0, 4.0, 6.0]
    frame_time = 50
    num_milestones = 3
    xi_bin_trajs = [
        [[1.0, 0.0], [1.0, 0.0], [3.0, 0.0], [1.0, 0.0], [3.0, 0.0], [5.0, 0.0],
...
def test_make_time_profiles_linear():
    ...
    transit_time_matrix = milestoning.make_time_profiles(
        transition_matrix, time_vector_up, time_vector_down, num_milestones)
